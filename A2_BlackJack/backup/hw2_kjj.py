    ...
    def get_succ_states(self, state):
        ...
        if phase == 'player':
            ...
            for n in range(1, 11):
                ...
                # print('-----------------------')
                # print(f'hand: {state[1]}')
                # print(f'useable ace: {state[2]}')
                # print(f'card drawn: {n}')
                player_hand, player_ace, prob = self.get_new_hand_value(state[1], state[2], n)
                # print(f'updated hand: {player_hand}')
                # print(f'updated ace: {player_ace}')
                # print('-----------------')
